...
public class ModItems {
    ...
    public static final RegistryObject<Item> FIRE_SWORD = ITEMS.register("fire_sword", () -> new FireSword(ModTiers.FIRE_SWORD, 2, 0, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_COMBAT)));

    public static final RegistryObject<Item> ICE_SWORD = ITEMS.register("ice_sword", () -> new IceSword(ModTiers.ICE_SWORD, 2, 0, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_COMBAT)));
